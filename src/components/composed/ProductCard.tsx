...
const TYPE_BADGE: Record<Product['type'], { label: string; bg: string; text: string }> = {
  tool: { label: 'Tool', bg: 'bg-blue-50', text: 'text-blueprint-blue' },
  accelerator: { label: 'Accelerator', bg: 'bg-green-50', text: 'text-green-700' },
  service: { label: 'Service', bg: 'bg-purple-50', text: 'text-purple-700' },
};
...
export function ProductCard({ product, onViewDetails }: ProductCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Trending Badge */}
      {isTrending && (
        <span className="absolute top-3 left-3 text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 bg-yellow-50 text-yellow-700 flex items-center gap-1">
