...
export function MessageSentModal({ onClose }: MessageSentModalProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative bg-white dark:bg-slate-900 shadow-xl w-full max-w-md text-center p-8 border-t-8 border-green-500"
      >
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-6 text-sm">Our sales team will get back to you shortly.</p>
        <button
          onClick={onClose}
