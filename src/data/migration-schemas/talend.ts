  ...
  sections: [
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      fields: [
        ...
        { name: 'cloudEngine', label: 'Remote / Cloud Engine', type: 'select', helpText: 'Using remote engine or cloud engine for execution?', options: [{ value: 'yes', label: 'Yes' }, { value: 'no', label: 'No' }] },
        { name: 'sharedModules', label: 'Shared Modules / Components', type: 'number', min: 0, helpText: 'Reusable shared components across projects' },
        { name: 'routineCount', label: 'Custom Java Routines', type: 'number', min: 0, helpText: 'Custom Java routines used in jobs' },
      ],
    },
