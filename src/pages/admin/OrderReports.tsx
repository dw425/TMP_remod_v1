...
export default function OrderReports() {
  ...
  return (
    <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p className="text-gray-500 mb-8">Track PO submissions, status, and revenue.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        <div className="sharp-card bg-white p-6">
          <p className="text-sm font-medium text-gray-500 uppercase">Approved Revenue</p>
        ...
        {['all', 'pending', 'submitted', 'approved', 'rejected'].map((s) => (
          <button
            ...
            className={`text-xs font-bold uppercase px-3 py-1.5 border ${
              statusFilter === s
                ? 'border-blueprint-blue text-blueprint-blue bg-blue-50'
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="text-left px-6 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Submitted</th>
                </tr>
              </thead>
              <tbody>
                {filtered.map((order) => {
